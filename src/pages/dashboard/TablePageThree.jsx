  ...
  const columns = [
    {
      ...
      value: [
        ...
        {
          id: "headerCell",
          coordination: { x: [9], y: [1] },
          dataVariant: "text-nowrap",
        },
        {
          id: "headerCell",
          coordination: { x: { from: "strCell", to: "edCell" }, y: 0 },
          dataVariant: "bg-amber-300",
        },
      ],
    },
    {
  ...
  const bodyData = [
    {
      ...
      value: [
        ...
        },
        {
          ...
          dataVariant: "border-r-0 border-b-0 bg-amber-500",
          dataPosition: "items-start justify-start",
        },
      ],
    },
  ...
  const merges = [
    { key: "manager", value: [] },
    {
      ...
      value: [
        ...
        { type: "header", startCol: 9, colSpan: 4, rowSpan: 1 },
