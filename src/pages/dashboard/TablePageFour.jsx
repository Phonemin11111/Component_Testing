    ...
    },
    {
      ...
      value: [
        [
          ...
          { header: "Origin", key: "origin.url", action: "links", serial: 2 },
          { header: "Link", key: "url", action: "links", serial: 3 },
      ...
      links: [
        {
          ...
          value: [
            {
              id: "linksVariant",
              dataColor: "text-red-500 hover:text-red-700",
              dataVariant: "",
              dataInt: linkData,
              iconInt: "#",
              iconVariant: "text-amber-500",
              // iconRepeat: false,
              iconCustom: "",
            },
            {
              id: "linksColumn",
              serial: 3,
              dataColor: "text-amber-500 hover:text-amber-700",
              dataVariant: "",
              iconInt: ["#", "+", "*"],
              iconVariant: "text-red-500",
              dataInt: ["Visit Here", "Link Data", "Data Link", "Here Link"],
              iconRepeat: false,
              dataRepeat: true,
              dataCustom: { 2: "Custom for Row 3", 7: "Special Row 8" },
              iconCustom: { 4: ">", 5: "<" },
            },
            // {
            //   id: "linksColumn",
